...
func (a *modifyWeb) AddTask(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: answer here
	tmpl := template.Must(template.ParseFS(a.embed, "views/main/add-task.html", "views/general/header.html"))
	tmpl.Execute(w, map[string]interface{}{"categoryID": catId})
}
...
func (a *modifyWeb) AddCategory(w http.ResponseWriter, r *http.Request) {
	// TODO: answer here
	tmpl := template.Must(template.ParseFS(a.embed, "views/main/add-category.html", "views/general/header.html"))
	tmpl.Execute(w, nil)
}
...
func (a *modifyWeb) UpdateTask(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: answer here
	tmpl := template.Must(template.ParseFS(a.embed, "views/main/update-task.html", "views/general/header.html"))
	tmpl.Execute(w, task)
}
